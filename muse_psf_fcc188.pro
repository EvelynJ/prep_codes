...
root='/raid/ejohnston/FCC188/BUDDI/'
  side=25.0
  ...
  fits_read,'/raid/ejohnston/FCC188/products_std/DATACUBE_FINAL_ZAPPED.fits',input,h
...
;  y_in=[260, 275, 146,  52, 48, 130, 96]
  x_in=[49,  63, 41,  96, 245];, 293]   ;using std datacube
  y_in=[99, 133, 51, 149, 278];, 263]
...
;    psf_new=PSF_GAUSSIAN( Npixel=101, FWHM=Psf_fwhm, /NORMAL )
  ...
  fits_write,root+'psf_median.fits',psf_cube_final,h
  stop
