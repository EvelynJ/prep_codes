...
pro MUSE_psf_FCC227;, input_file
...
root='/raid/ejohnston/FCC227/BUDDI/'
  side=25.0
...
;  fits_read,root+'DATACUBE_FINAL_ZAPPED2.fits',input,h
  fits_read,'/raid/ejohnston/FCC227/products_std/DATACUBE_FINAL_ZAPPED.fits',input,h
  psf_cube=fltarr(2*side+1,2*side+1,sxpar(h,'NAXIS3'))
  psf_fwhm_wave=fltarr(sxpar(h,'NAXIS3'))
  
;  x_in=[101, 98, 121, 127]  ;using original datacube
;  y_in=[164, 29, 271, 296]
  x_in=[64,  50, 42, 294,  75]   ;using std datacube
  y_in=[132, 98, 50, 262, 215]
