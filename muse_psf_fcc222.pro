...
pro MUSE_psf_FCC222;, input_file
...
root='/raid/ejohnston/FCC222/BUDDI/'
  side=20.0
...
;  fits_read,'/raid/ejohnston/FCC222/products_std/DATACUBE_FINAL_ZAPPED.fits',input,h
  fits_read,'/raid/ejohnston/FCC222/BUDDI/DATACUBE_FINAL_ZAPPED2_FLUX.fits',input,h
  ...
  x_in=[152, 151, 99]   ;input datacube
  y_in=[287, 260, 97]
