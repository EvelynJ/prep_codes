...
root='/raid/ejohnston/double_nucleated/0337/BUDDI/'
  side=20.0
...
;  fits_read,root+'DATACUBE_FINAL_ZAPPED2.fits',input,h
  fits_read,'/raid/ejohnston/double_nucleated/0337/products/DATACUBE_FINAL_ZAPPED.fits',input,h
