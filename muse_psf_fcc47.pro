...
root='/raid/ejohnston/FCC47/BUDDI/'
  side=20.0
...
;  fits_read,root+'DATACUBE_FINAL_ZAPPED2.fits',input,h
  fits_read,'/raid/ejohnston/FCC47/products/DATACUBE_FINAL_STD_ZAPPED.fits',input,h
  psf_cube=fltarr(2*side+1,2*side+1,sxpar(h,'NAXIS3'))
  psf_fwhm_wave=fltarr(sxpar(h,'NAXIS3'))
  
  x_in=[277,125,237,266, 77, 63,212,287,271]
  y_in=[ 64, 83,202, 97,219, 58, 35,181,118]
