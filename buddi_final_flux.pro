...
pro buddi_final_flux,input_file
...
for j=0,nfiles_1D-1,1 do begin
  ...
  for zz=0,s[1]-1,1 do begin
    ...
    input[zz]=input[zz]/(3.34e4*10^wave[zz]*10^wave[zz]*1e-20)
  endfor
  ...
  fits_write,root+decomp+decomp_dir+'decomposed_data_ergs/'+split[6],input,h
  ...
  if split[6] eq 'component1_flux.fits' then comp1=input_lin
  if split[6] eq 'component2_flux.fits' then comp2=input_lin
  if split[6] eq 'component3_flux.fits' then comp3=input_lin
  if split[6] eq 'component4_flux.fits' then comp4=input_lin
endfor


s_cube=size(input_lin)
...
for j=0,nfiles_cube-1,1 do begin
  ...
  print,split[6]
  fits_write,root+decomp+decomp_dir+'decomposed_data_ergs/'+split[6],input,extname='FLUX'
  modfits,root+decomp+decomp_dir+'decomposed_data_ergs/'+split[6],0,h
  modfits,root+decomp+decomp_dir+'decomposed_data_ergs/'+split[6],1,h_flux,extname='FLUX'
...
set_plot,'ps'
device,file=root+decomp+decomp_dir+'decomposed_data_ergs/Spectra_integrated.eps',/landscape;,xsize=11,ysize=8,/inches,/color;,/landscape
!P.thick=2
!p.charthick=3
!p.charsize=1.3
!p.multi=0;[0,1,4]
...
wavelength=10^wave
plot,wavelength,comp1,/NODATA,yrange=[-0.1,2.1],$
  ...
  if setup.n_comp eq 1000 then begin
    oplot,wavelength,(comp1/median(comp1)),color=cgcolor('blue');/10000;+90
  ...
  if setup.n_comp eq 1100 then begin
    oplot,wavelength,(comp1/median(comp1+comp2)),color=cgcolor('blue');/10000;+90
    oplot,wavelength,(comp2/median(comp1+comp2)),color=cgcolor('red');/10000;+90
    oplot,wavelength,((comp1+comp2)/median(comp1+comp2)),color=cgcolor('purple');/10000;+30,color=cgcolor('red')
  ...
  if setup.n_comp eq 1010 then begin
    oplot,wavelength,(comp1/median(comp1+comp3)),color=cgcolor('blue');/10000;+90
    oplot,wavelength,(comp3/median(comp1+comp3)),color=cgcolor('skyblue');/10000;+90
    oplot,wavelength,((comp1+comp3)/median(comp1+comp3)),color=cgcolor('purple');/10000;+30,color=cgcolor('red')
    al_legend,['Integrated spectrum from datacube','Comp1 + Comp3','Comp1','Comp3','Sky','Residuals'],linestyle=[0,0,0,0,0,0],$
  ...
  if setup.n_comp eq 1110 then begin
    oplot,wavelength,(comp1/median(comp1+comp2+comp3)),color=cgcolor('blue');/10000;+90
    oplot,wavelength,(comp2/median(comp1+comp2+comp3)),color=cgcolor('red');/10000;+90
    oplot,wavelength,(comp3/median(comp1+comp2+comp3)),color=cgcolor('skyblue');/10000;+90
    oplot,wavelength,((comp1+comp2+comp3)/median(comp1+comp2+comp3)),color=cgcolor('purple');/10000;+30,color=cgcolor('red')
    al_legend,['Integrated spectrum from datacube','Comp1 + Comp2 + Comp3','Comp1','Comp2','Comp3','Sky','Residuals'],linestyle=[0,0,0,0,0,0,0],$
  ...
  if setup.n_comp eq 1010 then begin
    oplot,wavelength,(comp1_cube/median(comp1+comp3_cube)),color=cgcolor('blue');/10000;+90
    oplot,wavelength,(comp3_cube/median(comp1+comp3_cube)),color=cgcolor('skyblue');/10000;+90
    oplot,wavelength,((comp1_cube+comp3_cube)/median(comp1_cube+comp3_cube)),color=cgcolor('purple');/10000;+30,color=cgcolor('red')
    al_legend,['Integrated spectrum from datacube','Comp1 + Comp3','Comp1','Comp3','Sky','Residuals'],linestyle=[0,0,0,0,0,0],$
      colors=[cgcolor('black'),cgcolor('purple'),cgcolor('blue'),cgcolor('skyblue'),cgcolor('dark grey'),cgcolor('olive')],charsize=0.9,box=0,/left,/top
  endif
  if setup.n_comp eq 1110 then begin
    oplot,wavelength,(comp1_cube/median(comp1_cube+comp2_cube+comp3_cube)),color=cgcolor('blue');/10000;+90
    oplot,wavelength,(comp2_cube/median(comp1_cube+comp2_cube+comp3_cube)),color=cgcolor('red');/10000;+90
    oplot,wavelength,(comp3_cube/median(comp1_cube+comp2_cube+comp3_cube)),color=cgcolor('skyblue');/10000;+90
    oplot,wavelength,((comp1_cube+comp2_cube+comp3_cube)/median(comp1_cube+comp2_cube+comp3_cube)),color=cgcolor('purple');/10000;+30,color=cgcolor('red')
    al_legend,['Integrated spectrum from datacube','Comp1 + Comp2 + Comp3','Comp1','Comp2','Comp3','Sky','Residuals'],linestyle=[0,0,0,0,0,0,0],$
      colors=[cgcolor('black'),cgcolor('purple'),cgcolor('blue'),cgcolor('red'),cgcolor('skyblue'),cgcolor('dark grey'),cgcolor('olive')],charsize=0.9,box=0,/left,/top
  endif
...
;    xtitle='Wavelength ('+cgSymbol("angstrom")+')',ytitle='Relative Flux',title=galaxy_ref
 ;   
;    
;  if setup.n_comp eq 1000 then comp2_cube=fltarr(s[1],s[2],s[3])
;  
;  if setup.n_comp ge 1100 then oplot,wavelength,(comp2_cube/median(comp1_cube+comp2_cube)),color=cgcolor('blue');/10000;+90
;  oplot,wavelength,(comp1_cube/median(comp1_cube+comp2_cube)),color=cgcolor('red');/10000;+60
;  oplot,wavelength,(orig/median(orig));/10000;+30
;  if setup.n_comp ge 1100 then oplot,wavelength,((comp1_cube+comp2_cube)/median(comp1_cube+comp2_cube)),color=cgcolor('purple');/10000;+30,color=cgcolor('red')
;  ;oplot,wavelength,((bulge_1D+disk_1D)-median(bulge_1D+disk_1D))/10+10,color=cgcolor('red')
;  oplot,wavelength,(resid/median(orig)),color=cgcolor('olive');/10000,color=cgcolor('green')
;  oplot,wavelength,(sky/median(orig)),color=cgcolor('dark grey');/10000,color=cgcolor('green')
;  
;  if setup.n_comp eq 1000 or setup.n_comp eq 1001 then al_legend,['Integrated spectrum from datacube','Comp1','Comp1','Sky','Residuals'],linestyle=[0,0,0,0,0],$
;  colors=[cgcolor('black'),cgcolor('purple'),cgcolor('blue'),cgcolor('dark grey'),cgcolor('olive')],charsize=0.9,box=0,/left,/top
;  
;if setup.n_comp eq 1100 or setup.n_comp eq 1101 then al_legend,['Integrated spectrum from datacube','Comp1 + Comp2','Comp1','Comp2','Sky','Residuals'],linestyle=[0,0,0,0,0,0],$
;  colors=[cgcolor('black'),cgcolor('purple'),cgcolor('blue'),cgcolor('red'),cgcolor('dark grey'),cgcolor('olive')],charsize=0.9,box=0,/left,/top
;  
;if setup.n_comp eq 1010 or setup.n_comp eq 1011 then al_legend,['Integrated spectrum from datacube','Comp1 + Comp3','Comp1','Comp3','Sky','Residuals'],linestyle=[0,0,0,0,0,0],$
;  colors=[cgcolor('black'),cgcolor('purple'),cgcolor('blue'),cgcolor('skyblue'),cgcolor('dark grey'),cgcolor('olive')],charsize=0.9,box=0,/left,/top
;  
;if setup.n_comp eq 1110 or setup.n_comp eq 1111 then al_legend,['Integrated spectrum from datacube','Comp1 + Comp2 + Comp3','Comp1','Comp2','Comp3','Sky','Residuals'],linestyle=[0,0,0,0,0,0,0],$
;  colors=[cgcolor('black'),cgcolor('purple'),cgcolor('blue'),cgcolor('red'),cgcolor('skyblue'),cgcolor('dark grey'),cgcolor('olive')],charsize=0.9,box=0,/left,/top
